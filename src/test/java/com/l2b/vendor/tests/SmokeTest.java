package com.l2b.vendor.tests;

import static org.assertj.core.api.Assertions.assertThat;

import com.l2b.vendor.base.BaseTest;
import com.l2b.vendor.pages.LanguagePage;
import com.l2b.vendor.pages.OnboardingCarouselPage;
import com.l2b.vendor.pages.OtpPage;
import com.l2b.vendor.pages.SignUpPage;
import com.l2b.vendor.utils.ApiClient;
import com.l2b.vendor.utils.Config;
...
public class SmokeTest extends BaseTest {
    ...
    public void splashScreen() {
        ...
        assertThat(language.isDisplayedNow())
                ...
                .isTrue();
        Response backend = new ApiClient().getRoot();
